...
def close_lid(config):
    ...
    with bosdyn.client.lease.LeaseKeepAlive(lease_client, must_acquire=True, return_at_exit=True):
        ...
        #This skill is performed from the right side of the coffee machine table
        cmd_poses = [
        ...
        [0.35, .75, 0.38, hooking_quat, 15.0],
        # [1.00, -0.1, 0.38, hooking_quat, 9.0],
        # [1.00, -0.2, 0.36, hooking_quat, 11.0],
        [0.75, 0, 0.38, neutral_quat, 16.0],
        [0.75, 0, 0.25, neutral_quat, 17]
        ]
